...
//Registra a resposta de um participante na questão
public class Resposta {
    ...
    public char getAlternativaMarcada() { return alternativaMarcada; }
    public void setAlternativaMarcada(char alternativaMarcada) { this.alternativaMarcada = alternativaMarcada; }
